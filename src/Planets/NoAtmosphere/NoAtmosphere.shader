...
uniform float rotation = 1.0; //hint_range(0.0, 6.28)
uniform vec2 light_origin = vec2(0.39, 0.39);
uniform float time_speed = 0.2; //hint_range(0.0, 1.0)
uniform float dither_size = 2.0; //hint_range(0.0, 10.0)
uniform float light_border_1 = 0.4; //hint_range(0.0, 1.0)
uniform float light_border_2 = 0.6; //hint_range(0.0, 1.0)
...
vec4 effect(vec4 color, Image texture, vec2 texture_coords, vec2 screen_coords){
	...
	bool dith = dither(uv ,texture_coords);
